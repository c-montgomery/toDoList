...
/***/ "./node_modules/css-loader/dist/cjs.js!./src/flatpickr.css":
/*!*****************************************************************!*\
  !*** ./node_modules/css-loader/dist/cjs.js!./src/flatpickr.css ***!
  \*****************************************************************/
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, "* {\n  vertical-align: baseline;\n  font-weight: inherit;\n  font-family: inherit;\n  font-style: inherit;\n  font-size: 100%;\n  border: 0 none;\n  outline: 0;\n  padding: 0;\n  margin: 0;\n}\n\nli,\ndd,\nblockquote {\n  margin-left: 40px;\n}\ntable {\n  border-collapse: collapse;\n  border-spacing: 0;\n}\n\n@font-face {\n  font-family: \"Average Sans\";\n  font-style: normal;\n  font-weight: 400;\n  src: url(" + ___CSS_LOADER_URL_REPLACEMENT_0___ + "); /* IE9 Compat Modes */\n  src: local(\"\"),\n    url(" + ___CSS_LOADER_URL_REPLACEMENT_1___ + ")\n      format(\"embedded-opentype\"),\n    /* IE6-IE8 */ url(" + ___CSS_LOADER_URL_REPLACEMENT_2___ + ")\n      format(\"woff2\"),\n    /* Super Modern Browsers */\n      url(" + ___CSS_LOADER_URL_REPLACEMENT_3___ + ") format(\"woff\"),\n    /* Modern Browsers */ url(" + ___CSS_LOADER_URL_REPLACEMENT_4___ + ")\n      format(\"truetype\"),\n    /* Safari, Android, iOS */\n      url(" + ___CSS_LOADER_URL_REPLACEMENT_5___ + ")\n      format(\"svg\"); /* Legacy iOS */\n}\n\nhtml {\n  display: flex;\n  flex-direction: column;\n  font-family: \"Average Sans\";\n  color: black;\n  background: rgb(162, 162, 162);\n  height: 100%;\n  text-align: right;\n}\nbody{\n  display: flex;\n  \n}\n.content {\n  display: inline-block;\n  width: 100%;\n  font-size: 50px;\n  justify-content: space-around;\n  background-color: rgba(0, 0, 0, 0.2);\n}\n.headerContainer {\n  background-color: #414141;\n}\nbutton {\n  font-size: 15px;\n  color: #b3b2b2;\n  transform: scale(0.99);\n  border: none;\n  z-index: 1;\n  border-radius: 2px;\n  margin: 3px 3px 6px;\n  transition: transform 0.3s;\n\n  padding: 0px 2px 0px 2px;\n  background-color: #6a6a6a;\n}\nbutton:hover {\n  color: black;\n  transform: scale(1);\n  border: none;\n  box-shadow: inset 1px 1px 13px #7db7ce;\n  box-shadow: 2px 2px 2px rgba(92, 91, 91, 0.3);\n  z-index: 21;\n  border-radius: 0px;\n  transition: transform 0.3s;\n  text-align: center;\n  background-color: #b0b0b0;\n}\n\nbutton:active {\n  box-shadow: inset 0px 3px 5px 0px #787878;\n  color: white;\n}\n.modal {\n  text-align: center;\n  z-index: 3;\n  font-size: 1.4rem;\n  animation: fadeIn linear 0.5s;\n  transition: 0.92s;\n  position: absolute;\n  margin: 10% 20% auto;\n  width: 40%;\n  height: 80%;\n  border: 1px rgb(108, 160, 228) solid;\n  padding: 10px;\n  border-radius: 6px;\n  background-color: rgba(235, 235, 235, 0.9);\n}\n\ndiv.addTasksModal {\n  z-index: 1;\n  min-width: 800px;\n  font-size: 4 rem;\n  animation: fadeIn linear 0.5s;\n  transition: 0.92s;\n  position: absolute;\n  margin: 80px auto;\n  width: 60vh;\n  height: 60vh;\n  border: 1px rgb(108, 160, 228) solid;\n  padding: 10px;\n  border-radius: 6px;\n  background-color: rgba(251, 255, 255, 0.9);\n}\n\n@keyframes fadeIn {\n  0% {\n    opacity: 0;\n  }\n  100% {\n    opacity: 1;\n  }\n}\n\nhtml > p {\n  border-bottom: black 1px solid;\n  margin: 1px;\n}\ninput {\n  width: 50vh;\n  margin-bottom: 5px;\n  margin-left: 5px;\n  font-size: 1rem;\n  border-top: 1px solid black;\n}\n\n.taskModalInput {\n  display: block;\n  width: 90%;\n  margin-bottom: 5px;\n  margin-left: 5px;\n  font-size: 1rem;\n  border-top: #686c6d 1px solid;\n}\n\n.darkened {\n  background-color: rgb(0, 0, 0.2);\n}\n\n.saveSubtask {\n  background-color: cornflowerblue;\n  position: absolute;\n  bottom: 0px;\n  right: 0px;\n}\n\n.save {\n  font-size: 1.4rem;\n  bottom: 10px;\n  right: 10px;\n  text-align: center;\n  cursor: pointer;\n  padding-right: 10px;\n  padding-left: 10px;\n  border-radius: 3px;\n}\n.save:hover {\n  transform: scale(1.03);\n  background-color: rgb(126, 141, 181);\n  box-shadow: 1px 5px 5px rgb(92, 91, 91);\n}\n\n.exit {\n  position: absolute;\n  font-size: 1rem;\n\n  top: 0px;\n  right: 0px;\n\n  text-align: center;\n  cursor: pointer;\n  border-radius: 5px;\n}\n\n.exit:hover {\n  transform: scale(1.03);\n  cursor: pointer;\n  background-color: red;\n  color: white;\n}\n\n.hidden {\n  display: block;\n}\n\nli {\n  list-style-type: none;\n}\n.warning {\n  color: red;\n}\n.sortDropdown div {\n  transition: width 0.3s, background-color 0.3s, font-size 1s, transform 2s;\n  color: black;\n  background-color: rgb(210, 210, 210);\n  padding: 5px;\n  width: 100%;\n}\n.sortDropdown div:hover {\n  width: 100%;\n  background-color: #8d9091;\n  cursor: default;\n}\n.sortDropdown{\n  transition: right .9s;\n  opacity: 100%;\n  right:0px;\n  top: 31px;\n  position: absolute;\n  border-radius: 3px;\n}\n\n.hidden{\n  opacity: 0%;\n  position: absolute;\n  right: 10px;\n}\n\n\n.headerContainer {\n  display: flex;\n  justify-content: space-between;\n}\n.dueDate {\n  display: inline-block;\n}\n.buttonHolder {\n  display: flex;\n  justify-content: space-evenly;\n}\n.green {\n  background-color: green;\n  color: white;\n}\n\nimg {\n  padding: 3px 2px 0px 2px;\n}\n.logoHolder {\n  display: flex;\n  justify-content: space-around;\n  margin: 3px 3px 6px;\n  padding: 0px 2px 0px 2px;\n}\n.logoText {\n  display: inline;\n  color: rgb(162, 162, 162);\n  font-size: 1.7rem;\n  padding-left: 5px;\n}\n.buttonHolder {\n  display: flex;\n  align-items: center;\n}\n", "",{"version":3,"sources":["webpack://./src/style.css"],"names":[],"mappings":"AAAA;EACE,wBAAwB;EACxB,oBAAoB;EACpB,oBAAoB;EACpB,mBAAmB;EACnB,eAAe;EACf,cAAc;EACd,UAAU;EACV,UAAU;EACV,SAAS;AACX;;AAEA;;;EAGE,iBAAiB;AACnB;AACA;EACE,yBAAyB;EACzB,iBAAiB;AACnB;;AAEA;EACE,2BAA2B;EAC3B,kBAAkB;EAClB,gBAAgB;EAChB,4CAAsD,EAAE,qBAAqB;EAC7E;;;;;;;;;;;mBAWiB,EAAE,eAAe;AACpC;;AAEA;EACE,aAAa;EACb,sBAAsB;EACtB,2BAA2B;EAC3B,YAAY;EACZ,8BAA8B;EAC9B,YAAY;EACZ,iBAAiB;AACnB;AACA;EACE,aAAa;;AAEf;AACA;EACE,qBAAqB;EACrB,WAAW;EACX,eAAe;EACf,6BAA6B;EAC7B,oCAAoC;AACtC;AACA;EACE,yBAAyB;AAC3B;AACA;EACE,eAAe;EACf,cAAc;EACd,sBAAsB;EACtB,YAAY;EACZ,UAAU;EACV,kBAAkB;EAClB,mBAAmB;EACnB,0BAA0B;;EAE1B,wBAAwB;EACxB,yBAAyB;AAC3B;AACA;EACE,YAAY;EACZ,mBAAmB;EACnB,YAAY;EACZ,sCAAsC;EACtC,6CAA6C;EAC7C,WAAW;EACX,kBAAkB;EAClB,0BAA0B;EAC1B,kBAAkB;EAClB,yBAAyB;AAC3B;;AAEA;EACE,yCAAyC;EACzC,YAAY;AACd;AACA;EACE,kBAAkB;EAClB,UAAU;EACV,iBAAiB;EACjB,6BAA6B;EAC7B,iBAAiB;EACjB,kBAAkB;EAClB,oBAAoB;EACpB,UAAU;EACV,WAAW;EACX,oCAAoC;EACpC,aAAa;EACb,kBAAkB;EAClB,0CAA0C;AAC5C;;AAEA;EACE,UAAU;EACV,gBAAgB;EAChB,gBAAgB;EAChB,6BAA6B;EAC7B,iBAAiB;EACjB,kBAAkB;EAClB,iBAAiB;EACjB,WAAW;EACX,YAAY;EACZ,oCAAoC;EACpC,aAAa;EACb,kBAAkB;EAClB,0CAA0C;AAC5C;;AAEA;EACE;IACE,UAAU;EACZ;EACA;IACE,UAAU;EACZ;AACF;;AAEA;EACE,8BAA8B;EAC9B,WAAW;AACb;AACA;EACE,WAAW;EACX,kBAAkB;EAClB,gBAAgB;EAChB,eAAe;EACf,2BAA2B;AAC7B;;AAEA;EACE,cAAc;EACd,UAAU;EACV,kBAAkB;EAClB,gBAAgB;EAChB,eAAe;EACf,6BAA6B;AAC/B;;AAEA;EACE,gCAAgC;AAClC;;AAEA;EACE,gCAAgC;EAChC,kBAAkB;EAClB,WAAW;EACX,UAAU;AACZ;;AAEA;EACE,iBAAiB;EACjB,YAAY;EACZ,WAAW;EACX,kBAAkB;EAClB,eAAe;EACf,mBAAmB;EACnB,kBAAkB;EAClB,kBAAkB;AACpB;AACA;EACE,sBAAsB;EACtB,oCAAoC;EACpC,uCAAuC;AACzC;;AAEA;EACE,kBAAkB;EAClB,eAAe;;EAEf,QAAQ;EACR,UAAU;;EAEV,kBAAkB;EAClB,eAAe;EACf,kBAAkB;AACpB;;AAEA;EACE,sBAAsB;EACtB,eAAe;EACf,qBAAqB;EACrB,YAAY;AACd;;AAEA;EACE,cAAc;AAChB;;AAEA;EACE,qBAAqB;AACvB;AACA;EACE,UAAU;AACZ;AACA;EACE,yEAAyE;EACzE,YAAY;EACZ,oCAAoC;EACpC,YAAY;EACZ,WAAW;AACb;AACA;EACE,WAAW;EACX,yBAAyB;EACzB,eAAe;AACjB;AACA;EACE,qBAAqB;EACrB,aAAa;EACb,SAAS;EACT,SAAS;EACT,kBAAkB;EAClB,kBAAkB;AACpB;;AAEA;EACE,WAAW;EACX,kBAAkB;EAClB,WAAW;AACb;;;AAGA;EACE,aAAa;EACb,8BAA8B;AAChC;AACA;EACE,qBAAqB;AACvB;AACA;EACE,aAAa;EACb,6BAA6B;AAC/B;AACA;EACE,uBAAuB;EACvB,YAAY;AACd;;AAEA;EACE,wBAAwB;AAC1B;AACA;EACE,aAAa;EACb,6BAA6B;EAC7B,mBAAmB;EACnB,wBAAwB;AAC1B;AACA;EACE,eAAe;EACf,yBAAyB;EACzB,iBAAiB;EACjB,iBAAiB;AACnB;AACA;EACE,aAAa;EACb,mBAAmB;AACrB","sourcesContent":["* {\n  vertical-align: baseline;\n  font-weight: inherit;\n  font-family: inherit;\n  font-style: inherit;\n  font-size: 100%;\n  border: 0 none;\n  outline: 0;\n  padding: 0;\n  margin: 0;\n}\n\nli,\ndd,\nblockquote {\n  margin-left: 40px;\n}\ntable {\n  border-collapse: collapse;\n  border-spacing: 0;\n}\n\n@font-face {\n  font-family: \"Average Sans\";\n  font-style: normal;\n  font-weight: 400;\n  src: url(\"../fonts/average-sans-v9-latin-regular.eot\"); /* IE9 Compat Modes */\n  src: local(\"\"),\n    url(\"../fonts/average-sans-v9-latin-regular.eot?#iefix\")\n      format(\"embedded-opentype\"),\n    /* IE6-IE8 */ url(\"../fonts/average-sans-v9-latin-regular.woff2\")\n      format(\"woff2\"),\n    /* Super Modern Browsers */\n      url(\"../fonts/average-sans-v9-latin-regular.woff\") format(\"woff\"),\n    /* Modern Browsers */ url(\"../fonts/average-sans-v9-latin-regular.ttf\")\n      format(\"truetype\"),\n    /* Safari, Android, iOS */\n      url(\"../fonts/average-sans-v9-latin-regular.svg#AverageSans\")\n      format(\"svg\"); /* Legacy iOS */\n}\n\nhtml {\n  display: flex;\n  flex-direction: column;\n  font-family: \"Average Sans\";\n  color: black;\n  background: rgb(162, 162, 162);\n  height: 100%;\n  text-align: right;\n}\nbody{\n  display: flex;\n  \n}\n.content {\n  display: inline-block;\n  width: 100%;\n  font-size: 50px;\n  justify-content: space-around;\n  background-color: rgba(0, 0, 0, 0.2);\n}\n.headerContainer {\n  background-color: #414141;\n}\nbutton {\n  font-size: 15px;\n  color: #b3b2b2;\n  transform: scale(0.99);\n  border: none;\n  z-index: 1;\n  border-radius: 2px;\n  margin: 3px 3px 6px;\n  transition: transform 0.3s;\n\n  padding: 0px 2px 0px 2px;\n  background-color: #6a6a6a;\n}\nbutton:hover {\n  color: black;\n  transform: scale(1);\n  border: none;\n  box-shadow: inset 1px 1px 13px #7db7ce;\n  box-shadow: 2px 2px 2px rgba(92, 91, 91, 0.3);\n  z-index: 21;\n  border-radius: 0px;\n  transition: transform 0.3s;\n  text-align: center;\n  background-color: #b0b0b0;\n}\n\nbutton:active {\n  box-shadow: inset 0px 3px 5px 0px #787878;\n  color: white;\n}\n.modal {\n  text-align: center;\n  z-index: 3;\n  font-size: 1.4rem;\n  animation: fadeIn linear 0.5s;\n  transition: 0.92s;\n  position: absolute;\n  margin: 10% 20% auto;\n  width: 40%;\n  height: 80%;\n  border: 1px rgb(108, 160, 228) solid;\n  padding: 10px;\n  border-radius: 6px;\n  background-color: rgba(235, 235, 235, 0.9);\n}\n\ndiv.addTasksModal {\n  z-index: 1;\n  min-width: 800px;\n  font-size: 4 rem;\n  animation: fadeIn linear 0.5s;\n  transition: 0.92s;\n  position: absolute;\n  margin: 80px auto;\n  width: 60vh;\n  height: 60vh;\n  border: 1px rgb(108, 160, 228) solid;\n  padding: 10px;\n  border-radius: 6px;\n  background-color: rgba(251, 255, 255, 0.9);\n}\n\n@keyframes fadeIn {\n  0% {\n    opacity: 0;\n  }\n  100% {\n    opacity: 1;\n  }\n}\n\nhtml > p {\n  border-bottom: black 1px solid;\n  margin: 1px;\n}\ninput {\n  width: 50vh;\n  margin-bottom: 5px;\n  margin-left: 5px;\n  font-size: 1rem;\n  border-top: 1px solid black;\n}\n\n.taskModalInput {\n  display: block;\n  width: 90%;\n  margin-bottom: 5px;\n  margin-left: 5px;\n  font-size: 1rem;\n  border-top: #686c6d 1px solid;\n}\n\n.darkened {\n  background-color: rgb(0, 0, 0.2);\n}\n\n.saveSubtask {\n  background-color: cornflowerblue;\n  position: absolute;\n  bottom: 0px;\n  right: 0px;\n}\n\n.save {\n  font-size: 1.4rem;\n  bottom: 10px;\n  right: 10px;\n  text-align: center;\n  cursor: pointer;\n  padding-right: 10px;\n  padding-left: 10px;\n  border-radius: 3px;\n}\n.save:hover {\n  transform: scale(1.03);\n  background-color: rgb(126, 141, 181);\n  box-shadow: 1px 5px 5px rgb(92, 91, 91);\n}\n\n.exit {\n  position: absolute;\n  font-size: 1rem;\n\n  top: 0px;\n  right: 0px;\n\n  text-align: center;\n  cursor: pointer;\n  border-radius: 5px;\n}\n\n.exit:hover {\n  transform: scale(1.03);\n  cursor: pointer;\n  background-color: red;\n  color: white;\n}\n\n.hidden {\n  display: block;\n}\n\nli {\n  list-style-type: none;\n}\n.warning {\n  color: red;\n}\n.sortDropdown div {\n  transition: width 0.3s, background-color 0.3s, font-size 1s, transform 2s;\n  color: black;\n  background-color: rgb(210, 210, 210);\n  padding: 5px;\n  width: 100%;\n}\n.sortDropdown div:hover {\n  width: 100%;\n  background-color: #8d9091;\n  cursor: default;\n}\n.sortDropdown{\n  transition: right .9s;\n  opacity: 100%;\n  right:0px;\n  top: 31px;\n  position: absolute;\n  border-radius: 3px;\n}\n\n.hidden{\n  opacity: 0%;\n  position: absolute;\n  right: 10px;\n}\n\n\n.headerContainer {\n  display: flex;\n  justify-content: space-between;\n}\n.dueDate {\n  display: inline-block;\n}\n.buttonHolder {\n  display: flex;\n  justify-content: space-evenly;\n}\n.green {\n  background-color: green;\n  color: white;\n}\n\nimg {\n  padding: 3px 2px 0px 2px;\n}\n.logoHolder {\n  display: flex;\n  justify-content: space-around;\n  margin: 3px 3px 6px;\n  padding: 0px 2px 0px 2px;\n}\n.logoText {\n  display: inline;\n  color: rgb(162, 162, 162);\n  font-size: 1.7rem;\n  padding-left: 5px;\n}\n.buttonHolder {\n  display: flex;\n  align-items: center;\n}\n"],"sourceRoot":""}]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
...
/* harmony import */ var _node_modules_css_loader_dist_cjs_js_flatpickr_css__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! !!../node_modules/css-loader/dist/cjs.js!./flatpickr.css */ "./node_modules/css-loader/dist/cjs.js!./src/flatpickr.css");
...
var update = _node_modules_style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0___default()(_node_modules_css_loader_dist_cjs_js_flatpickr_css__WEBPACK_IMPORTED_MODULE_6__.default, options);




       /* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (_node_modules_css_loader_dist_cjs_js_flatpickr_css__WEBPACK_IMPORTED_MODULE_6__.default && _node_modules_css_loader_dist_cjs_js_flatpickr_css__WEBPACK_IMPORTED_MODULE_6__.default.locals ? _node_modules_css_loader_dist_cjs_js_flatpickr_css__WEBPACK_IMPORTED_MODULE_6__.default.locals : undefined);
...
/* harmony import */ var _traffic_light_green_svg__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./traffic-light-green.svg */ "./src/traffic-light-green.svg");
/* harmony import */ var _traffic_light_yellow_svg__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./traffic-light-yellow.svg */ "./src/traffic-light-yellow.svg");
/* harmony import */ var _traffic_light_red_svg__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./traffic-light-red.svg */ "./src/traffic-light-red.svg");
/* harmony import */ var _traffic_light_svg__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./traffic-light.svg */ "./src/traffic-light.svg");
      ...
      if (obj.subtasksHidden === false){
        ...
        obj.subtaskArray.forEach((subtask)=>{
          ...
          subtaskDeleteButton.addEventListener('click', (e)=>{
            console.log(e)
            _ToDoClasses__WEBPACK_IMPORTED_MODULE_1__.ToDoItems.removeSubtask(list,e.target.parentElement.firstChild.data, e.target.parentElement.pare.firstChild.data)
...
/* harmony import */ var _flatpickr_css__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./flatpickr.css */ "./src/flatpickr.css");
...
"use strict";
module.exports = __webpack_require__.p + "1c16fcd1b22795fdb380.svg";
...
"use strict";
module.exports = __webpack_require__.p + "151a3effeb80e8119d0a.svg";

/***/ }),

/***/ "./src/traffic-light-red.svg":
/*!***********************************!*\
  !*** ./src/traffic-light-red.svg ***!
  \***********************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {
...
"use strict";
module.exports = __webpack_require__.p + "87a969813de5bf9a8fb2.svg";

/***/ }),

/***/ "./src/traffic-light-yellow.svg":
/*!**************************************!*\
  !*** ./src/traffic-light-yellow.svg ***!
  \**************************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {
...
"use strict";
module.exports = __webpack_require__.p + "a3e3a17dafa3fd7274c8.svg";
...
"use strict";
module.exports = __webpack_require__.p + "1f86bf087839775bd043.svg";
...
/* harmony import */ var _done_svg__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./done.svg */ "./src/done.svg");
...
sortButton.addEventListener('click',()=>{
  _Modal__WEBPACK_IMPORTED_MODULE_2__.Modal.toggleHidden('.sortDropdown')
})
addItem.textContent = "+";
...
if (savedList !== null){
  console.log('line 58')
  if (_Display__WEBPACK_IMPORTED_MODULE_3__.list.list.length == 0){
    console.log('controller if')
    _Display__WEBPACK_IMPORTED_MODULE_3__.list.replace = savedList
